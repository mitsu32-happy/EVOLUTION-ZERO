...
SOURCES = [
    CompanionSource(
        "raptorling",
        Path(r"C:\Users\oushi\.codex\generated_images\019e5eb7-bc4f-76e3-b6c7-23276e187e20\ig_09bf6931d79ad6d0016a2dcf6240f88191b79706a43b658de6.png"),
        "right-facing fast run with alternating contact and kick-off poses",
        "right-facing leap, claw, bite, recovery poses",
    ),
    CompanionSource(
        "spino_pup",
        Path(r"C:\Users\oushi\.codex\generated_images\019e5eb7-bc4f-76e3-b6c7-23276e187e20\ig_09bf6931d79ad6d0016a2dcf998aa48191b13b0d3636649fdc.png"),
        "right-facing heavy walk with sail, tail, and weight-shift poses",
        "right-facing water shot and splash recoil poses",
    ),
    CompanionSource(
        "medic_saur",
        Path(r"C:\Users\oushi\.codex\generated_images\019e5eb7-bc4f-76e3-b6c7-23276e187e20\ig_09bf6931d79ad6d0016a2dcfd5cf9481918fa5bb572084fc65.png"),
        "right-facing gentle walk with smaller contact changes",
        "self-contained healing aura poses with no patient or extra dinosaur",
    ),
    CompanionSource(
        "ptera_chick",
        Path(r"C:\Users\oushi\.codex\generated_images\019e5eb7-bc4f-76e3-b6c7-23276e187e20\ig_09bf6931d79ad6d0016a2dd01ac564819183407001d2262a21.png"),
    ...
    CompanionSource(
        "tricera_calf",
        Path(r"C:\Users\oushi\.codex\generated_images\019e5eb7-bc4f-76e3-b6c7-23276e187e20\ig_09bf6931d79ad6d0016a2dd060fa2c81919adad625cc6bfc87.png"),
        "right-facing heavy quadruped walk with stomp and horn motion",
        "self-contained guard and shield aura poses",
    ),
    CompanionSource(
        "para_juvenile",
        Path(r"C:\Users\oushi\.codex\generated_images\019e5eb7-bc4f-76e3-b6c7-23276e187e20\ig_09bf6931d79ad6d0016a2dd09b08f081919d3501c963f16d9d.png"),
        "right-facing light walk with crest, head, and tail motion",
        "self-contained sonar and pickup-guidance poses",
    ),
    CompanionSource(
        "stego_calf",
        Path(r"C:\Users\oushi\.codex\generated_images\019e5eb7-bc4f-76e3-b6c7-23276e187e20\ig_09bf6931d79ad6d0016a2dd0d826c08191a395d26247303ad7.png"),
        "right-facing heavy walk with plate and tail motion",
        "self-contained plate charge and stomp shockwave poses",
    ),
    CompanionSource(
        "rex_hatchling",
        Path(r"C:\Users\oushi\.codex\generated_images\019e5eb7-bc4f-76e3-b6c7-23276e187e20\ig_09bf6931d79ad6d0016a2dd115b1988191bf3bc6cb0b6fad2e.png"),
        "right-facing forceful small-run with head and tail counterbalance",
        "right-facing charge, bite, impact, recovery poses",
    ),
    CompanionSource(
        "compy_pack",
        Path(r"C:\Users\oushi\.codex\generated_images\019e5eb7-bc4f-76e3-b6c7-23276e187e20\ig_09bf6931d79ad6d0016a2dd1560908819188897df5c61fa007.png"),
        "right-facing three-compy pack run with offset foot timing",
        "right-facing group lunge and bite flurry poses",
    ),
    CompanionSource(
        "exp_chaser",
        Path(r"C:\Users\oushi\.codex\generated_images\019e5eb7-bc4f-76e3-b6c7-23276e187e20\ig_09bf6931d79ad6d0016a2dd1a546dc8191aaac15349860c72b.png"),
...
def isolate_subject(frame: Image.Image, companion_id: str) -> tuple[Image.Image, dict]:
    # P04i prompts generate a single right-facing subject per frame (except the
...
def normalize_frame(frame: Image.Image, companion_id: str, row: int) -> tuple[Image.Image, dict]:
    ...
    max_width = 318 if companion_id != "compy_pack" else 332
    max_height = 292 if row != 2 else 306
    scale = min(max_width / crop.width, max_height / crop.height, 1.08)
    resized = crop.resize(
...
def process_source(item: CompanionSource) -> dict:
    ...
    target = PUBLIC_DIR / f"{item.companion_id}_sprite_sheet_p04i.png"
...
def make_contact(report: list[dict]) -> None:
    ...
    contact.save(DOC_ASSET_DIR / "p04i_companion_sprite_contact.png")
...
def main() -> None:
    ...
    make_contact(report)
    out = {
        "title": "MVP-P04i Companion Dino regenerated animation-ready sprite sheets",
    ...
    report_path = DOC_ASSET_DIR / "p04i_companion_sprite_report.json"
    report_path.write_text(json.dumps(out, ensure_ascii=False, indent=2), encoding="utf-8")
    print(json.dumps({
        "processed": len(report),
        "contact": str((DOC_ASSET_DIR / "p04i_companion_sprite_contact.png").relative_to(ROOT)),
