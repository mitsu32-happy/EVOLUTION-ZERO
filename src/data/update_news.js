export const UPDATE_NEWS = [
  ...
  },
  {
    ...
    date: '2026/06/23',
    category: 'HOTFIX',
    title: '攻撃エフェクトと読み込み処理を改善しました',
    isImportant: true,
    body: [
      '今回の主な更新内容',
      '・通常技エフェクトが簡易表示に置き換わらないようにし、公式エフェクトを優先して表示するよう改善しました。',
      '・エフェクト未ロード時は簡易グラフィックへ置換せず、公式エフェクトの読み込み完了を待つか、負荷状況に応じて省略するようにしました。',
      '・選択中の恐竜、進化候補、ステージ、ボス関連アセットを優先読み込みするよう改善しました。',
      '・アセット読み込みとエフェクト表示状況を確認できる診断情報を追加しました。',
    ],
  },
  {
  ...
  },
  {
    ...
    date: '2026/06/21',
    category: '大型アップデート',
    title: 'コンプソグナトゥスにミニ群れを追加しました',
    isImportant: true,
    body: [
      '今回の主な更新内容',
      '・コンプソグナトゥス選択時に小型の仲間2体が追従し、低威力の支援攻撃を行う専用仕様を追加しました。',
      '・お供恐竜とは別枠で動作し、セーブデータや共存シナジーには影響しません。',
    ],
  },
  {
