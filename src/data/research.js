...
export const RESEARCH_ITEMS = [
  {
    ...
    name: 'DNA回収効率',
    description: 'リザルトで得られるDNAを研究段階ごとに増やす',
  ...
  },
  {
    ...
    category: RESEARCH_CATEGORY_IDS.bodyEnhancement,
    name: '初期耐久強化',
    description: '出撃開始時の最大HPを研究段階ごとに増やす',
    effectLabel: '初期HP +8',
    effectType: 'maxHp',
    effectPerLevel: 8,
    effectUnit: 'HP',
  ...
  },
  {
    ...
    category: RESEARCH_CATEGORY_IDS.bodyEnhancement,
    name: '移動安定化',
    description: '出撃中の移動速度を研究段階ごとに少し高める',
    effectLabel: '移動速度 +8',
  ...
  },
  {
    ...
    category: RESEARCH_CATEGORY_IDS.bodyEnhancement,
    name: '回収範囲強化',
    description: 'EXP結晶やDNA片の吸引開始範囲を研究段階ごとに広げる',
    effectLabel: '回収範囲 +8%',
  ...
  },
  {
    ...
    category: RESEARCH_CATEGORY_IDS.bodyEnhancement,
    name: '攻撃出力強化',
    description: '通常技と適応技の基礎ダメージを研究段階ごとに少し高める。',
    effectLabel: '攻撃出力 +4%',
  ...
  },
  {
    ...
    category: RESEARCH_CATEGORY_IDS.bodyEnhancement,
    name: '攻撃間隔短縮',
    description: '通常技の発動間隔を研究段階ごとにわずかに短縮する。',
    effectLabel: '通常技間隔 -3%',
  ...
  },
  {
    ...
    category: RESEARCH_CATEGORY_IDS.bodyEnhancement,
    name: '防御組織強化',
    description: '被ダメージを研究段階ごとにわずかに抑える。',
    effectLabel: '被ダメージ -3%',
  ...
  },
  {
    ...
    category: RESEARCH_CATEGORY_IDS.bodyEnhancement,
    name: 'EXP解析効率',
    description: 'EXP結晶の解析効率を研究段階ごとに少し高める。',
    effectLabel: 'EXP解析 +5%',
  ...
  },
  {
    ...
    name: '裂爪衝撃波',
    description: '爪撃系のスキル技を解析し、候補へ追加する',
    effectLabel: 'スキル技解放',
    material: 'DNA + 研究Pt',
    iconName: 'slashWave',
    status: 'locked',
    unlockHint: 'MVP-087で候補接続予定',
  },
  {
    id: 'poison_spore_unlock',
    category: RESEARCH_CATEGORY_IDS.adaptationAbility,
    name: '毒胞子散布',
    description: '毒性適応の範囲技を解析し、ビルド候補を増やす',
    effectLabel: '候補へ出現',
    material: 'DNA + 研究Pt',
    iconName: 'poisonSpore',
    status: 'locked',
    unlockHint: '専用エフェクト生成対象',
  },
  {
    id: 'bone_spike_unlock',
    category: RESEARCH_CATEGORY_IDS.adaptationAbility,
    name: '骨片スパイク',
    description: '骨質変異を射出攻撃へ転用する解析枠',
    effectLabel: '専用アイコン対象',
    material: 'DNA + 研究Pt',
    iconName: 'boneSpike',
    status: 'locked',
    unlockHint: '研究Pt接続後に解放',
  },
  {
    id: ADAPTATION_RESEARCH_IDS.acceleratedBlades,
    category: RESEARCH_CATEGORY_IDS.adaptationAbility,
    name: '加速刃群 解放',
    description: '周囲に高速刃を展開し、近くの敵を切り刻む。',
    effectLabel: '高速適応',
    adaptationTag: 'speed',
    ...
    costStep: 0,
    researchPtCost: 13,
    unlockHint: '研究後、候補へ出現',
  },
  {
    id: ADAPTATION_RESEARCH_IDS.predatorMarking,
    category: RESEARCH_CATEGORY_IDS.adaptationAbility,
    name: '捕食マーキング 解放',
    description: '近い敵へ捕食マークを放ち、追加ダメージを与える。',
    effectLabel: '狩猟適応',
  ...
  },
  {
    ...
    category: RESEARCH_CATEGORY_IDS.adaptationAbility,
    name: '火炎吐息 解放',
    description: '前方へ火炎を吐き、複数の敵を焼き払う。',
    effectLabel: '攻撃適応',
  ...
  },
  {
    ...
    name: '野性分岐解析',
    description: '攻撃系タグから未知の分岐進化候補を検出する',
    effectLabel: '進化ルート解放',
    material: 'DNA + 研究Pt',
  ...
  },
  {
    ...
    category: RESEARCH_CATEGORY_IDS.specialMutation,
    name: '結晶変異解析',
    description: '硬質化とエネルギー反応の組み合わせを解析する',
    effectLabel: '未知進化解析',
    material: 'DNA + 研究Pt',
    iconName: 'specialMutation',
    status: 'locked',
    unlockHint: 'MVP-088で候補接続予定',
  },
  {
    id: 'predator_route_scan',
    category: RESEARCH_CATEGORY_IDS.specialMutation,
    name: '捕食特化ルート',
    description: '捕食適応タグから特殊な分岐候補を探索する',
    effectLabel: '分岐候補追加',
    material: 'DNA + 研究Pt',
    iconName: 'evolutionBranch',
    status: 'locked',
  ...
  },
  {
    ...
    name: '未確認恐竜解析',
    description: '未解放個体の生体データを研究施設で復元する',
    effectLabel: '恐竜解析',
    material: '研究Pt',
    iconName: 'unknownDinoScan',
    status: 'locked',
    unlockHint: 'MVP-089で接続予定',
  },
  {
    id: 'spinosaurus_unlock',
    category: RESEARCH_CATEGORY_IDS.unknownDomain,
    name: 'スピノサウルス解析',
    description: '中距離制圧型の水流個体を復元し、出撃候補へ登録する。',
  ...
  },
  {
    ...
    category: RESEARCH_CATEGORY_IDS.unknownDomain,
    name: '深層ステージ調査',
    description: '新しい進化環境を探索し、出撃候補を増やす',
    effectLabel: 'ステージ解析',
    material: '研究Pt',
    iconName: 'stageScan',
    status: 'locked',
  ...
  },
  {
    ...
    category: RESEARCH_CATEGORY_IDS.unknownDomain,
    name: 'ZERO環境予測',
    description: 'ZERO解放条件ではなく、死線環境の反応傾向を研究施設で予測する',
    effectLabel: '環境反応予測',
    material: '研究Pt',
    iconName: 'unknownDomain',
    status: 'locked',
